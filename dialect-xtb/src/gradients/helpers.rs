...
use crate::initialization::{atom::XtbAtom, basis::Basis, system::XtbSystem};
use crate::parameters::{REP_ALPHA_PARAMS, REP_Z_EFF_PARAMS};
use nalgebra::Point3;
...
pub fn gradient_disp3_xtb(atoms: &[XtbAtom], full_config: &Configuration) -> Array1<f64> {
