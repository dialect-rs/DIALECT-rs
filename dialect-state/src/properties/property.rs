...
pub enum Property {
    ...
    VecF64(Vec<f64>),
    /// Vector of 1D arrays (e.g. stored NACV vectors)
    VecArray1(Vec<Array1<f64>>),
    VecAtom(Vec<Atom>),
...
impl From<BroydenMixerNew> for Property {
    fn from(value: BroydenMixerNew) -> Self {
        Property::MixerNew(value)
    }
}
...
impl From<Vec<Array1<f64>>> for Property {
    fn from(value: Vec<Array1<f64>>) -> Self {
        Property::VecArray1(value)
    }
}
