...
pub fn fmo_scc_end_trimer(
    ...
    info!(
        "{:<29} {:>24.14} Hartree",
        "sum of trimer energies:", e_trimer
    );
    info!(
        "{:<29} {:>24.14} Hartree",
        "sum of trimer emb. energies:", e_emd_trimer
    );
    info!(
        "{:<29} {:>24.14} Hartree",
        "sum of D3 dispersion energy:", e_disp
    ...
    info!(
        "{:<29} {:>24.14} Hartree",
        "total energy:",
        e_monomer + e_pairs + e_emb + e_esd + e_disp + e_trimer + e_emd_trimer
    );
    info!("{:-<80} ", "");
    info!("{}", timer);
}
