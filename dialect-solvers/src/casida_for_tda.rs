use crate::traits::AlternateCasidaEngine;
use crate::utils;
use ndarray::prelude::*;
use ndarray_linalg::*;
...
pub struct AlternateCasidaError;

impl fmt::Display for AlternateCasidaError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(f, "Casida solver did not converge!")
    }
}

impl error::Error for AlternateCasidaError {}

/// Structure with the configuration data
pub struct CasidaSolverTDA {
...
impl CasidaSolverTDA {
    ...
    pub fn new<D: AlternateCasidaEngine>(
        engine: &mut D,
        guess: Array2<f64>,
        ...
        shell_resolved: bool,
    ) -> Result<Self, AlternateCasidaError> {
        ...
        let mut result = Err(AlternateCasidaError);
        ...
        for i in 0..max_iter {
            ...
            if dim_sub + roots_lft <= max_space {
                ...
                for vec in q_s.axis_iter(Axis(1)) {
                    ...
                    let orth_v: Array1<f64> = &vec_n - &guess.dot(&guess.t().dot(&vec_n));
